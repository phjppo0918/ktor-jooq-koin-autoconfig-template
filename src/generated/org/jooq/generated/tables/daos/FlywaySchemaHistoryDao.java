...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, FlywaySchemaHistory, Integer> {
    ...
    public FlywaySchemaHistoryDao() {
        super(JFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(JFlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, FlywaySchemaHistory.class, configuration);
    }
     ...
     * Fetch a unique record that has <code>installed_rank = value</code>
     */
    public Optional<FlywaySchemaHistory> fetchOptionalByInstalledRank(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<FlywaySchemaHistory> fetchRangeOfInstalledOn(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<FlywaySchemaHistory> fetchByInstalledOn(LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<FlywaySchemaHistory> fetchRangeOfSuccess(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<FlywaySchemaHistory> fetchBySuccess(Boolean... values) {
